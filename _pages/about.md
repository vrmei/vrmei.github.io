...
In addition, I am passionate about **large language models (LLMs)**. My previous work involved **LLM-based UI agents**, **multimodal alignment**, and fine-tuning visual-language models (e.g., Qwen-VL-Chat, GLM4V).<img src="https://img.shields.io/badge/citations-24-9cf?logo=Google%20Scholar&labelColor=f6f6f6&style=flat">
